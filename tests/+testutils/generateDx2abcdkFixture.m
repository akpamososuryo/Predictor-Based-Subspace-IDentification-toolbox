function generateDx2abcdkFixture(outputPath)
%generateDx2abcdkFixture  Write MATLAB reference fixture for Python parity tests.
%
% Usage:
%   testutils.generateDx2abcdkFixture
%   testutils.generateDx2abcdkFixture('fixtures/matlab_reference/dx2abcdk_fixture.mat')

if nargin < 1 || isempty(outputPath)
    repoRoot = fileparts(fileparts(fileparts(mfilename('fullpath'))));
    outputPath = fullfile(repoRoot, 'fixtures', 'matlab_reference', 'dx2abcdk_fixture.mat');
end
...
n_cases = 3;
seeds_base = [41 141 241];
seeds_stable1 = [42 142 242];
...
K_stable1 = K_stable1_c1; %#ok<NASGU>

meta = struct();
meta.note = 'Deterministic MATLAB fixture for dx2abcdk baseline and stable1 parity checks (3 cases)';
meta.createdBy = 'testutils.generateDx2abcdkFixture';
meta.f = f_base_c1;
meta.p = p_base_c1;
...
save(outputPath, ...
    ...
    'x_base_c1', 'u_base_c1', 'y_base_c1', 'f_base_c1', 'p_base_c1', 'A_base_c1', 'B_base_c1', 'C_base_c1', 'D_base_c1', 'K_base_c1', ...
    'x_base_c2', 'u_base_c2', 'y_base_c2', 'f_base_c2', 'p_base_c2', 'A_base_c2', 'B_base_c2', 'C_base_c2', 'D_base_c2', 'K_base_c2', ...
    'x_base_c3', 'u_base_c3', 'y_base_c3', 'f_base_c3', 'p_base_c3', 'A_base_c3', 'B_base_c3', 'C_base_c3', 'D_base_c3', 'K_base_c3', ...
    'x_stable1_c1', 'u_stable1_c1', 'y_stable1_c1', 'f_stable1_c1', 'p_stable1_c1', 'A_stable1_c1', 'B_stable1_c1', 'C_stable1_c1', 'D_stable1_c1', 'K_stable1_c1', ...
    'x_stable1_c2', 'u_stable1_c2', 'y_stable1_c2', 'f_stable1_c2', 'p_stable1_c2', 'A_stable1_c2', 'B_stable1_c2', 'C_stable1_c2', 'D_stable1_c2', 'K_stable1_c2', ...
    'x_stable1_c3', 'u_stable1_c3', 'y_stable1_c3', 'f_stable1_c3', 'p_stable1_c3', 'A_stable1_c3', 'B_stable1_c3', 'C_stable1_c3', 'D_stable1_c3', 'K_stable1_c3', ...
    'x_base', 'u_base', 'y_base', 'f_base', 'p_base', 'A_base', 'B_base', 'C_base', 'D_base', 'K_base', ...
    'x_stable1', 'u_stable1', 'y_stable1', 'f_stable1', 'p_stable1', 'A_stable1', 'B_stable1', 'C_stable1', 'D_stable1', 'K_stable1');
