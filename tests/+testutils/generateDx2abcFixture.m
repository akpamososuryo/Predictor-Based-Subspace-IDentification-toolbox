function generateDx2abcFixture(outputPath)
%generateDx2abcFixture  Write MATLAB reference fixture for Python dx2abc parity tests.

if nargin < 1 || isempty(outputPath)
    repoRoot = fileparts(fileparts(fileparts(mfilename('fullpath'))));
    outputPath = fullfile(repoRoot, 'fixtures', 'matlab_reference', 'dx2abc_fixture.mat');
end
...
meta = struct();
meta.note = 'Deterministic MATLAB fixture for dx2abc baseline and stable1 parity checks (3 cases)';
meta.createdBy = 'testutils.generateDx2abcFixture';
meta.f = f_base_c1;
meta.p = p_base_c1;
...
save(outputPath, ...
    ...
    'x_base_c1', 'u_base_c1', 'y_base_c1', 'f_base_c1', 'p_base_c1', 'A_base_c1', 'B_base_c1', 'C_base_c1', ...
    'x_base_c2', 'u_base_c2', 'y_base_c2', 'f_base_c2', 'p_base_c2', 'A_base_c2', 'B_base_c2', 'C_base_c2', ...
    'x_base_c3', 'u_base_c3', 'y_base_c3', 'f_base_c3', 'p_base_c3', 'A_base_c3', 'B_base_c3', 'C_base_c3', ...
    'x_stable1_c1', 'u_stable1_c1', 'y_stable1_c1', 'f_stable1_c1', 'p_stable1_c1', 'A_stable1_c1', 'B_stable1_c1', 'C_stable1_c1', ...
    'x_stable1_c2', 'u_stable1_c2', 'y_stable1_c2', 'f_stable1_c2', 'p_stable1_c2', 'A_stable1_c2', 'B_stable1_c2', 'C_stable1_c2', ...
    'x_stable1_c3', 'u_stable1_c3', 'y_stable1_c3', 'f_stable1_c3', 'p_stable1_c3', 'A_stable1_c3', 'B_stable1_c3', 'C_stable1_c3', ...
    'x_base', 'u_base', 'y_base', 'f_base', 'p_base', 'A_base', 'B_base', 'C_base', ...
    'x_stable1', 'u_stable1', 'y_stable1', 'f_stable1', 'p_stable1', 'A_stable1', 'B_stable1', 'C_stable1');
